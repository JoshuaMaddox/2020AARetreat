  ...
  return (
    <Layout>
      ...
      <div className="main-message">
        ...
        <h3>Step Four:</h3>
        <p>Once you've finished recording, grab the embed code. Be sure to select the "Responsive" option before copying and then paste it into the form below. The following video shows how to do that:</p>
        <iframe class="airtable-embed" src="https://www.loom.com/embed/7f68fa7f01e349cab91b0c36168f68c3" frameborder="0" onmousewheel="" width="100%" height="533" style={{background: 'transparent', border: '1px solid #ccc'}} ></iframe>
        <h3>The Form:</h3>
